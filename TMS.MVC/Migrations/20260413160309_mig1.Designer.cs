...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMS.MVC.Models.DriverContact", b =>
                {
                    ...
                    b.Property<bool>("ConfirmedInSamava")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TMS.MVC.Models.DriverTractor", b =>
                {
                    b.Property<int>("DriverProfileId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("DriverProfileId", "TractorId");

                    b.HasIndex("TractorId");

                    b.ToTable("DriverTractors");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.Tractor", b =>
                {
                    ...
                    b.Property<string>("TrailerCategory")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("TMS.MVC.Models.TractorOwnerLink", b =>
                {
                    b.Property<int>("TractorOwnerProfileId")
                        .HasColumnType("int");

                    b.Property<int>("TractorId")
                        .HasColumnType("int");

                    b.HasKey("TractorOwnerProfileId", "TractorId");

                    b.HasIndex("TractorId");

                    b.ToTable("TractorOwnerLinks");
                });

            modelBuilder.Entity("TMS.MVC.Models.TractorOwnerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TractorOwnerProfiles");
                });

            modelBuilder.Entity("TMS.MVC.Models.TrailerInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TMS.MVC.Models.TractorOwnerLink", b =>
                {
                    b.HasOne("TMS.MVC.Models.Tractor", "Tractor")
                        .WithMany("TractorOwnerLinks")
                        .HasForeignKey("TractorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TMS.MVC.Models.TractorOwnerProfile", "TractorOwnerProfile")
                        .WithMany("TractorOwnerLinks")
                        .HasForeignKey("TractorOwnerProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Tractor");

                    b.Navigation("TractorOwnerProfile");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.Tractor", b =>
                {
                    ...
                    b.Navigation("TractorOwnerLinks");
