...
namespace TMS.MVC.Migrations
{
    ...
    [Migration("20260508162024_mig16")]
    partial class mig16
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMS.MVC.Models.CargoAnnouncement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CreatedHavalehNumber")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("CustomerCompanyName");

                    b.HasIndex("Status", "CreatedAt");

                    b.ToTable("CargoAnnouncements");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.DriverWalletWithdrawalRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("PaymentReceiptNote")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.ToTable("DriverWalletWithdrawalRequests");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.ProductProperty", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TMS.MVC.Models.SubHavaleh", b =>
                {
                    ...
                    b.Property<string>("GoodsOwnerPriceCurrency")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.Property<string>("LateDeliveryPenaltyCurrency")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("TMS.MVC.Models.SubHavalehAssignmentRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("CreatedTractorAssignmentId")
                        .HasColumnType("bigint");

                    b.Property<int?>("DriverProfileId")
                        .HasColumnType("int");

                    b.Property<bool>("IsTruckCapacityFull")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("RequestedLoadingDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("CreatedTractorAssignmentId");
                    ...
                    b.HasIndex("SubHavalehId", "Status");

                    b.HasIndex("TractorId", "Status");

                    b.ToTable("SubHavalehAssignmentRequests");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TMS.MVC.Models.TicketMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsOperatorReply")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TMS.MVC.Models.TractorWalletWithdrawalRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TractorWalletWithdrawalRequests");
                });
            ...
            modelBuilder.Entity("TransportAgreementDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TransportAgreementId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransportAgreementId", "UploadedAt");

                    b.ToTable("TransportAgreementDocuments");
                });
            ...
            modelBuilder.Entity("TMS.MVC.Models.SubHavalehAssignmentRequest", b =>
                {
                    b.HasOne("TMS.MVC.Models.TractorAssignment", "CreatedTractorAssignment")
                        .WithMany()
                        .HasForeignKey("CreatedTractorAssignmentId")
                    ...
                    b.HasOne("TMS.MVC.Models.ApplicationUser", "RequesterUser")
                        .WithMany()
                        .HasForeignKey("RequesterUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TMS.MVC.Models.ApplicationUser", "ReviewedByUser")
                        .WithMany()
                    ...
                    b.Navigation("CreatedTractorAssignment");
            ...
            modelBuilder.Entity("TMS.MVC.Models.Ticket", b =>
                {
                    b.HasOne("TMS.MVC.Models.ApplicationUser", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TMS.MVC.Models.TicketMessage", b =>
                {
                    b.HasOne("TMS.MVC.Models.ApplicationUser", "SenderUser")
                        .WithMany()
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TMS.MVC.Models.Ticket", "Ticket")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TransportAgreementDocument", b =>
                {
                    b.HasOne("TransportAgreement", "TransportAgreement")
                        .WithMany("Documents")
                        .HasForeignKey("TransportAgreementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TransportAgreement");
                });
