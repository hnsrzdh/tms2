...
namespace TMS.MVC.Models
{
    public class TractorAssignment
    {
        ...
        [StringLength(50)]
        public string? SettledTo { get; set; } // "Driver" یا "Tractor"
    ...
    public class LoadingDocument
    {
        ...
        public string? DocumentType { get; set; } // بارنامه، فاکتور، مجوز و...
    ...
    public class UnloadingDocument
    {
        ...
        [StringLength(100)]
        [Display(Name = "نوع مدرک")]
        public string? DocumentType { get; set; } // رسید تخلیه، قبض انبار و...
    ...
    // Models/LocationTracking.cs (برای رهگیری لحظه‌ای)
    ...
    public class ChatMessage
    {
        ...
        public string SenderRole { get; set; } = string.Empty; // "Driver" or "Operator" or "Admin"
