...
{
    public class TractorWalletWithdrawalCreateVm
    {
    ...
    public class TractorWalletWithdrawalIndexVm
    {
        ...
        public List<TractorWalletWithdrawalItemVm> Items { get; set; } = new();
    }

    public class TractorWalletTransactionVm
    {
    ...
    public class TractorWalletWithdrawalItemVm
    {
        ...
        public TractorWalletWithdrawalRequestStatus Status { get; set; }
