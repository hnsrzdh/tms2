  ...
  if ($("#annotations-chart").length > 0) {
    ...
    e.append(
      "<div style='position:absolute;left:" +
        ...
        "px;top:" +
        g.top +
        "px;color:#666;font-size:smaller'>گرم کردن</div>"
    ),
      (g = f.pointOffset({
        x: 8,
        y: -1.2,
      ...
      e.append(
        "<div style='position:absolute;left:" +
          ...
          "px;top:" +
          g.top +
          "px;color:#666;font-size:smaller'>اندازه‌گیری‌های واقعی</div>"
      );
...
$(function () {
  ...
  var data = [
    { color: "#f73164", points: data1_points, data: data1, label: "اطلاعات 1" },
    { color: "#ea9200", points: data2_points, data: data2, label: "اطلاعات 2" },
    {
      color: "#02a2b9",
      lines: { show: true },
      points: data3_points,
